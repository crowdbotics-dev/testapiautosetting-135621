...
class Testconnectors135621ViewSet(BaseConnectorViewSet):
    PASSWORD = settings.CONNECTOR_TESTCONNECTORS135621_PASSWORD
    USERNAME = settings.CONNECTOR_TESTCONNECTORS135621_USERNAME
    BASE_URL = "https://devstringx.com"
    AUTH_TYPE = "basic"
    IDENTIFIER = "CONNECTOR_TESTCONNECTORS135621"
